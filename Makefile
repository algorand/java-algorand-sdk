...
integration:
	mvn test -Dcucumber.filter.tags="@algod or @assets or @auction or @kmd or @send @send.keyregtxn or @template or @indexer or @rekey or @applications.verified or @applications or @compile or @dryrun or @indexer.applications or @applications.evaldelta or @indexer.231"
