...
public class TestDecode {
    ...
    public void TestBoolArray0() {
        ...
        assertThat(Type.fromString("bool[5]").decode(new byte[]{(byte) 0b10011000})).isEqualTo(inputs);
    }

    @Test
    public void TestBoolArray1() {
        Boolean[] inputs = new Boolean[]{false, false, false, true, true, false, true, false, true, false, true};
        assertThat(Type.fromString("bool[11]").decode(new byte[]{0b00011010, (byte) 0b10100000})).isEqualTo(inputs);
    }

    @Test
    public void TestBoolArray2() {
        Boolean[] inputs = new Boolean[]{false, false, false, true, true, false, true, false, true, false, true};
        assertThat(Type.fromString("bool[]").decode(new byte[]{0x00, 0x0B, 0b00011010, (byte) 0b10100000})).isEqualTo(inputs);
    }
    ...
    public void TestUintArray() {
        ...
        assertThat(Type.fromString("uint64[8]").decode(new byte[]{
    ...
    public void TestTuple0() {
        ...
        assertThat(Type.fromString("(string,bool,bool,bool,bool,string)").decode(new byte[]{
    ...
    public void TestBoolArrayTuple0() {
        ...
        assertThat(Type.fromString("(bool[2],bool[2])").decode(expected)).isEqualTo(elements);
    }
    ...
    public void TestBoolArrayTuple1() {
        ...
        assertThat(Type.fromString("(bool[2],bool[])").decode(encoded)).isEqualTo(elements);
    }
    ...
    public void TestBoolArrayTuple2() {
        ...
        assertThat(Type.fromString("(bool[],bool[])").decode(encoded)).isEqualTo(elements);
    }
    ...
    public void TestEmptyTuple() {
        assertThat(Type.fromString("()").decode(new byte[0])).isEqualTo(new Object[0]);
    }
}
