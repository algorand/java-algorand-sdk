...
public class TestTransaction {
    ...
    public void testSerializationAssetConfig() throws Exception {
        ...
        Transaction tx = new Transaction(addr, BigInteger.valueOf(3790), BigInteger.valueOf(322575), BigInteger.valueOf(323575), null, "", new Digest(gh), addr, BigInteger.valueOf(1234), addr, addr, addr, addr);
        ...
        System.out.println(Encoder.encodeToBase64(outBytes));
        System.out.flush();
