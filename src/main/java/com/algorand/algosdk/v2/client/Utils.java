...
public class Utils {
     ...
     * @param txns the array of SignedTransactions that should be used to generate the DryrunRequest 
     ...
     * @param round The agreement round or block height the dryrun should include
    ...
    public static DryrunRequest creatDryrun(AlgodClient client, SignedTransaction[] txns, String protocol_version, Long latest_timestamp, Long round)
            throws Exception {
